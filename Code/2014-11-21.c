...
void execute()
{
    ...
    {
        int commandNumber = 0;
        ///printpipeline(ln->pipelines[pipelineNumber], pipelineNumber);
    ...
    for(pipelineNumber=0;pipelineNumber < lineLength;++pipelineNumber)
    {
        ...
        for(commandNumber = 0;commandNumber<pipelineLength;++commandNumber)
        {
            ...
            printcommand(com, commandNumber);
            ...
            else /** child */
            {
                ...
                fprintf(stderr, "REDIRS COUNT %d\n", l);
                for(i=0;i<l;++i)
                {
                    fprintf(stderr, "JESTEM %d\n", (com->redirs)[i]);
